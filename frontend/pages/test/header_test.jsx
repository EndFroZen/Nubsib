            ...
            <header className="bg-white shadow bgimg">
                <div className="mx-auto px-4 py-3 sm:px-6 lg:px-8 blurs">
                    <div className="flex items-baseline space-x-4">
                        <h1 className="text-2xl font-bold tracking-tight text-blue-900">sr</h1>
                        <Link href={{ pathname: '/test' }}>
                            <p className={`${pathname === '/test' ? 'bg-blue-600 text-white shadow-lg shadowbt' : 'text-gray-500 hover:bg-blue-400 hover:text-white'} rounded-md px-3 py-2 text-sm font-medium flex btrd `}><Icon className='h-5 w-5 mr-1' icon='solar:home-add-broken' />หน้าแรก</p>
                        </Link>
                        <Link href={{ pathname: '/test/srreq' }}>
                            <p className={`${pathname === '/test/srreq' ? 'bg-blue-600 text-white shadow-lg shadowbt' : 'text-gray-500 hover:bg-blue-400 hover:text-white'} rounded-md px-3 py-2 text-sm font-medium flex btrd `}><Icon className='h-5 w-5 mr-1' icon='solar:home-add-broken' />หน้าจัดการ</p>
                        </Link>
